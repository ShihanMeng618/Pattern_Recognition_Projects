#!/usr/bin/python
# -*- coding:utf-8 -*-
# https://github.com/Anirudha-N/K-Nearest-Neighbour-using-MNIST-Dataset
import csv
import numpy as np
import operator
...
def main():
    ...
    for num in [30000, 60000]:
        train_matrix = np.array(train_dataset[0:num]).astype("int")
        ...
        accuracy.append((true_postives / float(len(test_matrix))) * 100.0)
